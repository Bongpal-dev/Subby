...
/// 온보딩 튜토리얼 전용 화면
/// 더미 HomeScreen UI를 보여주고 튜토리얼 툴팁을 순차적으로 표시
      ...
      child: Stack(
        children: [
          PageView(
            ...
            children: [
              _FabTutorialPage(onTap: _goToNextPage),
              _SummaryCardTutorialPage(onTap: _goToNextPage),
              _DrawerTutorialPage(onTap: _goToNextPage),
              _WelcomeCompletePage(onStart: _completeTutorial),
            ],
          ),
          // 페이지 인디케이터
          Positioned(
...
/// Step 1: FAB 튜토리얼 페이지
class _FabTutorialPage extends StatelessWidget {
  final VoidCallback onTap;

  const _FabTutorialPage({required this.onTap});
...
/// Step 2: Summary Card 튜토리얼 페이지
class _SummaryCardTutorialPage extends StatelessWidget {
  final VoidCallback onTap;

  const _SummaryCardTutorialPage({required this.onTap});
...
/// Step 3: 드로어 튜토리얼 페이지
class _DrawerTutorialPage extends StatelessWidget {
  final VoidCallback onTap;

  const _DrawerTutorialPage({required this.onTap});
